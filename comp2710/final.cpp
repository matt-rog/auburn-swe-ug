...
int main (int argc, char **argv) {
    ...
    //Parameters--> 1st: thread id; 2nd: NULL; 3rd: a proper prededined function 4th: what you want to pass to the new thread
    for (i=0; i<N; i++) {
